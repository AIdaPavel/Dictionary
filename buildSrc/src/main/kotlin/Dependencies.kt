...
object Config {
    const val application_id = "pavel.ivanov.dictionary"
...
object Versions {
    ...
    //Koin
    const val koinAndroid = "2.2.2"
    const val koinViewModel = "2.2.2"
...
object Koin {
    ...
    const val koin_view_model_x = "org.koin:koin-android-viewmodel:${Versions.koinViewModel}"
    const val test_compile = "io.insert-koin:koin-test:${Versions.koinViewModel}"
}
